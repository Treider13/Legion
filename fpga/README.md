...
**Онбордовый перехват (режим «Умная атака»):** после Старта
хозяин один — SDR. Ноутбук задаёт коридор, выдержку усилителя на найденной
частоте (можно 0.4 мс), Старт/Стоп и наблюдение.
Антенна на RX1 / RX SMA. Плата сама смотрит эфир в аналоговом окне взгляда
(шаг сетки = фильтр; потолок x40 ≤28 МГц, micro ≤56 МГц, каталог Nuand)
и сама открывает TX1 / TX SMA на усилитель. USB в круге «увидел → усилитель»
