...
хозяин один — SDR. Ноутбук — рубильник (Старт/Стоп) и наблюдение.
Антенна SMA → RX. Плата сама смотрит эфир в аналоговом окне фильтра
(x40 ≤28 МГц, micro ≤56 МГц, каталог Nuand) и сама открывает TX на
усилитель по SMA. USB в круге «увидел → усилитель» не участвует:
IQ на компьютер не гоняется, хозяин кабеля на каждый пик не меняется.
...
- Надо обежать коридор шире фильтра → плата шагает LO: один взгляд —
  десятки МГц, не 100. Это миллисекунды на обзор, не микросекунды.
