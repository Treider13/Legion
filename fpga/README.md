...
- **Эфир+FPGA:** Soapy только паркует RX и TX LO на одну частоту при 2 MSPS
  (окно детектора 16 сэмплов ≈ 8 мкс), затем отдаёт USB агенту. Это не
  хостовый скан 40 MSPS и не синтез волны из каталога: на усилитель идёт
  тот же RX IQ, что пришёл с антенны, когда энергия выше порога.
