          ...
          <>
            ...
            {path === "air" && (
              <p className="cinema-gate-warn">
                Ретрансляция — одночастотный тракт: возможна утечка собственного сигнала с выхода
                на вход. Сильная утечка держит гейт открытым после пропадания цели — автовозврат
                тогда не сработает. Разнесите антенны RX и TX и не выкручивайте усиление в
                максимум. Кнопка «Стоп» и сторожевой таймер работают всегда.
              </p>
            )}
          </>
        ) : mode === "sdr" && step === "path" ? (
