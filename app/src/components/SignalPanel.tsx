  ...
  return (
    <section className="panel">
      ...
      <p className="panel-note">
        Волна синтезируется на хосте (fs {WAVE_FS / 1e6} МГц, буфер 65536 I/Q) и крутится в
        TX-петле SDR: ось 0 Гц — на частоте ниже. Предпросмотр — точная модель спектра.
        ЗАШИТЬ — только при подтверждённой нагрузке 50 Ом (вкладка СКАН + TX SDR) и полосе
        allowlist. ESP32 в этом тракте не участвует.
      </p>
