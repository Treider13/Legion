...
- **SDR (хост)** — каталог bladeRF / HackRF / Lime / Pluto / USRP / RTL-SDR,
  проверка образов FPGA/FX3, SCAN RX по allowlist, CUE на синтезатор, ток PA
  и интерлок нагрузки 50 Ом. Не путать с коридором TX.
